...
This project contains a prototype implementation of an RAG chatbot system which uses project metrics as context to answer user questions about their project.\
This Markdown briefly explains development-relevant matters, with more information in the related paper.\
